...
public class TC_003_YahooExtentREPORT {
	...
	public void setExtent() {
		...
		extent.addSystemInfo("Host Name", "Prathibha Windows10 ");
		extent.addSystemInfo("User Name", "Prathibha");
		extent.addSystemInfo("Environment", "SDET");
	...
	public void TitleTest1() {
		extentTest = extent.startTest("TitleTest1");
	...
	public void TitleTest2() {
		extentTest = extent.startTest("TitleTest2");
		String title = driver.getTitle();
		System.out.println(title);
		Assert.assertEquals(title, "yah");
	}
	...
	public void tearDown(ITestResult result) throws IOException {
		...
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			String screenshotPath = TC_003_YahooExtentREPORT.getScreenshot(driver, result.getName());
		...
		driver.get("file:///C:/Users/Prathibha%20Heggodu/Desktop/MyProject/Softvision/ExtentReport/ExtentReport.html");
		driver.quit();
	}
